...
<head>
    ...
    <style>
        ...
        /* Updated viewport/screen container wrapper optimized for smartphone/iPhone aspect ratios */
...
<body>
    ...
    <script type="module">
        ...
        const camera = new THREE.PerspectiveCamera(45, viewportContainer.clientWidth / viewportContainer.clientHeight, 0.1, 1000);
