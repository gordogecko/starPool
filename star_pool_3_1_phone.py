...
<head>
    ...
    <style>
        ...
        /* 9:16 Aspect Ratio Enforcer Container */
        #app-container {
            position: relative;
            width: 100vw;
            height: 100vh;
        ...
        .power-track {
            ...
            border: 2px solid var(--shield-purple);
...
<body>
    <div id="app-container">
        ...
        <div id="victory-overlay" class="overlay hidden">
            <div class="overlay-content" style="border-color:var(--laser-cyan); box-shadow: 0 0 30px rgba(0,243,255,0.4);">
                ...
                <p style="font-size: 16px; color: #fff;">FLIGHT MANEUVERS: <span id="final-shots" class="stat-val">0</span></p>
                <p style="font-size: 16px; color: #fff;">SCORE: <span id="final-score" class="stat-val">0</span></p>
    ...
    <script type="module">
        ...
        const maxRadius = 34; // Updated relative to the new smaller mobile-sized joystick
